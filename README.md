...
## Project Description
The purpose of this project is creating a database system, which will be implemented in **MS SQL** and proper integrations to a website for a **real company**. Database will store the sell and stock information of the company that is specialized in personal care products and cologne.
