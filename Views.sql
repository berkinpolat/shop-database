-- Average cost of orders from Istanbul
...
-- How many orders have been placed from which city.
...
-- How many orders have been placed from which category.
...
-- Most money spent by the first 3 companies
